[README.md](https://github.com/user-attachments/files/23467231/README.md)
# 中国专利转让网络分析项目
...
**本项目已支持 Windows/macOS/Linux 跨平台运行!**

详细说明请查看: [`AI-patent/跨平台兼容性说明.md`](AI-patent/跨平台兼容性说明.md)
...
**2024年11月 - 跨平台兼容性更新**
- ✨ 新增 `font_config.py` 跨平台字体配置模块
- ✨ 新增 `r_font_config.R` R语言字体配置
- 🔧 移除所有硬编码的Mac专用字体
- 🔧 统一字体配置,支持 Windows/macOS/Linux
- 📝 添加详细的跨平台兼容性文档
